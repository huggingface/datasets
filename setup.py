...
TESTS_REQUIRE = [
    ...
    "tensorflow>=2.6.0; python_version<'3.10'; sys_platform != 'win32'",  # numpy-2 is not supported for Python < 3.10
    "tensorflow>=2.16.0; python_version>='3.10'; sys_platform != 'win32'",  # Pins numpy < 2
    "tiktoken",
    "torch>=2.0.0",
    "torchdata",
    "soundfile>=0.12.1",
