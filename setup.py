...
REQUIRED_PKGS = [
    ...
    "dill>=0.3.9,<0.4.5",  # tmp pin until dill has official support for determinism see https://github.com/uqfoundation/dill/issues/19
...
setup(
    name="datasets",
    version="3.5.1.dev0",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
