...
TESTS_REQUIRE = [
    ...
    "torch>=2.8.0",
    "torchdata",
    # "git+https://github.com/huggingface/transformers.git@ci-test-huggingface-hub-v1.0.0.rc1",  # Pins numpy < 2
    "zstandard",
...
DOCS_REQUIRE = [
    ...
    # "git+https://github.com/huggingface/transformers.git@ci-test-huggingface-hub-v1.0.0.rc1",
    "torch",
    "tensorflow>=2.6.0",
]
...
setup(
    name="datasets",
    version="4.1.2.dev0",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
