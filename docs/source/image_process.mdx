...
<Tip>
PyTorch's data augmentations use PIL under the hood, installing [Pillow](https://pillow.readthedocs.io/en/latest/installation.html) will increase performance by 2/3x in most systems/
</Tip>
