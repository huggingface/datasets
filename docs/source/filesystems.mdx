...
- - Azure DataLake
  - [adl](https://github.com/dask/adlfs)
- - Azure Blob
  - [abfs](https://github.com/dask/adlfs)
- - Dropbox
  - [dropboxdrivefs](https://github.com/MarineChap/dropboxdrivefs)
- - Google Drive
  - [gdrivefs](https://github.com/intake/gdrivefs)
