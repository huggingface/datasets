...
**5**. Set the format of your dataset to be compatible with your machine learning framework:
...
**6**. The dataset is now ready for training with your machine learning framework!
