...
For more details specific to loading other dataset modalities, take a look at the [load audio dataset guide](./audio_load) or the [load image dataset guide](./image_load).
