...
- `hf://` URLs for files in any repository or [Storage Bucket](https://huggingface.co/docs/hub/storage-buckets) on Hugging Face, e.g. `data_files=["hf://buckets/julien-c/my-training-bucket/julien/affluence.csv"]`
