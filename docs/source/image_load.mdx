...
folder/train/cat/bengal.png
```
and your `metadata.jsonl` file looks like this:
...
>>> dataset[0]
{"image": <PIL.JpegImagePlugin.JpegImageFile image mode=RGB size=640x480 at 0x7F5182C7AD30>, "label": 0, "text": "This is a golden retriever"}
```
