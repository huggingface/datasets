...
It concerns datasets that are not under a namespace, e.g. "rajpurkar/squad" or "glue", unlike the other datasets that are named "username/dataset_name" or "org/dataset_name".
