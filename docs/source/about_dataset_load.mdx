...
<img align="center" src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/datasets/builderconfig.png"/>
...
- Provide a list of predefined [`datasets.BuilderConfig`] class (or subclass) instances in the datasets [`datasets.DatasetBuilder.BUILDER_CONFIGS`] attribute.
...
<img align="center" src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/datasets/datasetbuilder.png"/>
