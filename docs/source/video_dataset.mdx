...
For more details on the WebDataset format and the Python library, please check the [WebDataset documentation](https://huggingface.co/docs/hub/datasets-webdataset).
