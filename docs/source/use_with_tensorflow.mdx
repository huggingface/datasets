...
In particular, a TensorFlow formatted dataset outputs a `RaggedTensor` instead of one single tensor:
...
But if you want, you can explicitly format certain columns and leave the other columns unformatted:
