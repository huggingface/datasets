...
There are two methods for creating an audio dataset you can share. This guide will show you how to:

* Create an audio dataset with `AudioFolder` and metadata. This is a no-code solution for quickly creating a smaller dataset to experiment with.

* Create an audio dataset by writing a loading script. This method requires more effort and coding, but you have greater flexibility over how a dataset is defined, downloaded, and generated.
...
In some cases, a dataset may have more than one configuration. The LibriVox Indonesia dataset has several configurations corresponding to different languages.
