...
Furthermore it is also possible to save :obj:`datasets.Dataset` and :obj:`datasets.DatasetDict` to other filesystems and cloud storages such as S3 by  by using respectively :func:`datasets.Dataset.save_to_disk` 
