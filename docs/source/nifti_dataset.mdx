...
If you're working in a Jupyter notebook-like environment, we added support for visualizing images directly in the notebook. When you load an image dataset, the images will be displayed automatically when you return them.
