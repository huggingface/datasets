...
You can control access to your dataset by requiring users to request access first. Users will have to share their contact information in order to access the dataset. Check out the [Gated datasets](https://huggingface.co/docs/hub/datasets-gated) guide for more information about this Hub feature.
