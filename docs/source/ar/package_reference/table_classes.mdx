...
يتم دعم كل كائن `Dataset` بواسطة جدول PyArrow. يمكن تحميل جدول من القرص (مُخزن في الذاكرة) أو في الذاكرة. هناك عدة أنواع من الجداول المتاحة، وكلها موروثة من [`table.Table`].
