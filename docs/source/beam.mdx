...
We have already created Beam pipelines for some of the larger datasets like [wikipedia](https://huggingface.co/datasets/wikipedia), and [wiki40b](https://huggingface.co/datasets/wiki40b). You can load these normally with [`datasets.Datasets.load_dataset`]. But if you want to run your own Beam pipeline with Dataflow, here is how:
