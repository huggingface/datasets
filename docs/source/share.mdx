...
In a dataset repository, you can host all your data files and [configure your dataset](./repository_structure#define-your-splits-and-subsets-in-yaml) to define which file goes to which split.
