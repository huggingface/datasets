...
To work with video datasets, you need to have the `decord` packaged installed. Check out the [installation](https://github.com/dmlc/decord?tab=readme-ov-file#installation) guide to learn how to install it, or on [related discussions](https://github.com/dmlc/decord/issues/213).
