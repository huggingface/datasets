...
The main use-case for rank is to parallelize computation across several GPUs. This requires setting `multiprocessing.set_start_method("spawn")`. If you don't you'll receive the following CUDA error:
