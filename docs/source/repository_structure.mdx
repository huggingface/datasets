...
Or specify if you want to load labels from a metadata file of your [`ImageFolder` dataset](.image_dataset#imagefolder):
...
- config_name: labelled
  data_dir: images_with_labels
  drop_labels: false
- config_name: unlabelled
  data_dir: images_without_labels
  drop_labels: true
---
```
