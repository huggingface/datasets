...
If you have multiple files, choose which file goes into which split using YAML at the top of your README.md:
...
## Define your splits in YAML

If you want to define yourself which file goes into which split, you can use the YAML `configs` field at the top of your README.md using glob patterns.
...
You can define your splits by adding the YAML `configs` field in the YAML block at the top of your README.md:
...
## Dataset configurations and subsets

Sometimes your dataset is made of several types of fiels that could represent different configurations or subsets of you dataset.
In that case you can define one pattern per configuration:
...
Each configuration is shows separately on the Hugging Face Hub, and can be loaded using
