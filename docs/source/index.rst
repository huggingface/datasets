...
- 🤗 Datasets currently provides access to ~700 NLP datasets and ~30 evaluation metrics and is designed to let the community easily add and share new datasets and evaluation metrics. You can browse the full set of datasets with the live [🤗 Datasets viewer](https://huggingface.co/datasets/viewer/).
