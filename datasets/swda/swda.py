...
# Dialogue act integer labels. It encodes the actual act tags into integer values.
act_label = {
    "sd": 0,
    "b": 1,
    "sv": 2,
            ...
            features=datasets.Features(
                {
                    ...
                    "dialogue_act_tag": datasets.Value("string"),
                    "dialogue_act_label": datasets.Value("int16"),
                }
            ),
        ...
        with open(filepath, encoding="utf-8") as f:
            for id_, row in enumerate(f):
                ...
                yield f"{split}-{id_}", {
                    ...
                    "dialogue_act_label": act_label[parsed_row[2]],
                }
