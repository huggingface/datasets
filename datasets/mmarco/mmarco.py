...
class MsMarco(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            features=datasets.Features({"doc_id": datasets.Value("int32"), "document": datasets.Value("string")}),
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(name="collection", gen_kwargs={"filepath": dl_path["collections"]}),
        ...
        with open(filepath, encoding="utf-8") as f:
            if self.config.name == "v1.1":
                for line in f:
                    ...
                    features = {"doc_id": doc_id, "document": doc}
