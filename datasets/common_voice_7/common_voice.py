...
class CommonVoice(datasets.GeneratorBasedBuilder):
    ...
    def manual_download_instructions(self):
        return """ You need to manually the dataset from `https://commonvoice.mozilla.org/en/datasets`.
        Make sure the version is set to Common Voice Corpus 7.0 and choose a language of your choice.
        You will have to enter your email address to download the dataset.
        Having downloaded the dataset you can extract it with: ``tar -xvzf <link-to-downloaded-file>`` which should create a folder called ``cv-corpus-7.0-2021-07-21``.
        The dataset can then be loaded with `datasets.load_dataset("common_voice", <lang-id>, data_dir="<path/to/folder>") whereas the <lang-id> corresponds to the language id of your chosen language."""
