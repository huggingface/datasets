...
class Gnad10(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        task_templates=[TextClassification(labels=('Etat', 'Inland', 'International', 'Kultur', 'Panorama', 'Sport', 'Web', 'Wirtschaft', 'Wissenschaft'), text_column='text', label_column='label')])
