...
- other
task_ids:
- other-other-Text-to-speech, Web-search
---
...
-   `example`: a `string` feature.
  - The dataset is stored as plaintext file where each line is an example of space separated segments of a domain name. 
### Data Splits
