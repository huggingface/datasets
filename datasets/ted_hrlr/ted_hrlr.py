...
=======
    ...
    def __init__(self, language_pair=(None, None), **kwargs):
        """BuilderConfig for TED talk data comparing high/low resource languages.
>>>>>>> b160bcc506d6f385108f2669494379d16bdff030
...
class TedHrlrTranslate(nlp.GeneratorBasedBuilder):
    ...
    def _info(self):
        return nlp.DatasetInfo(
            ...
            features=nlp.Features(
                {
                    "translation": nlp.features.Translation(
                        languages=self.builder_config.language_pair
                    ),
                }
            ),
            homepage="https://github.com/neulab/word-embeddings-for-nmt",
            supervised_keys={
                "input": self.builder_config.language_pair[0],
                "output": self.builder_config.language_pair[1],
            },
            citation=_CITATION,
        )
