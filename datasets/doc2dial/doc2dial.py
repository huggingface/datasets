                ...
                for dial in dials:
                    ...
                    for idx, turn in enumerate(dial["turns"]):
                        ...
                        if "references" not in turn:
                            turn["references"] = self._create_answers_merging_text_ref_rc(turn["reference"], doc["spans"], doc["doc_text"])
                        ...
                        if "references" not in turn_to_predict:
                            turn_to_predict["references"] = self._create_answers_merging_text_ref_rc(turn_to_predict["reference"], doc["spans"], doc["doc_text"])
