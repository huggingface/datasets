...
# Dataset Card for Xitsonga Ner Corpus
...
- **Homepage:** [Xitsonga Ner Corpus Homepage](https://repo.sadilar.org/handle/20.500.12185/362)
- **Repository:**
- **Paper:**
- **Leaderboard:**
...
The Xitsonga Ner Corpus is a Xitsonga dataset developed by [The Centre for Text Technology (CTexT), North-West University, South Africa](http://humanities.nwu.ac.za/ctext). The data is based on documents from the South African goverment domain and crawled from gov.za websites. It was created to support NER task for Xitsonga language. The dataset uses CoNLL shared task annotation standards.
...
The language supported is Xitsonga.
...
The data was created to help introduce resources to new language - Xitsonga.
