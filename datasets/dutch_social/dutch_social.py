...
_DESCRIPTION = """\
The dataset contains 10 files with around 271,342 tweets. The tweets are filtered via the official Twitter API to
...
_URLs = {"first_domain": "https://storage.googleapis.com/corona-tweet/dutch-tweets.zip"}
            ...
            for id_, data in enumerate(tweets):
                if self.config.name == "first_domain":
                    yield id_, {
                        ...
                        "sentiment_pattern": data["sentiment_pattern"],
                        "subjective_pattern": data["subjective_pattern"],
