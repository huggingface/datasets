...
class ArxivDataset(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        feature_names = [_ID, _SUBMITTER, _AUTHORS, _TITLE, _COMMENTS, _JOURNAL_REF, _DOI, _REPORT_NO, _CATEGORIES, _LICENSE, _ABSTRACT, _VERSIONS, _UPDATE_DATE, _AUTHORS_PARSED]
