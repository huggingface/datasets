...
_DATA_URL = "https://github.com/SunbirdAI/toy-datasets/blob/main/dummy-enlg.zip"
...
class SunbirdConfig(datasets.BuilderConfig):
    ...
    def __init__(self, language_pair=(None, None), **kwargs):
        ...
        assert non_en in ["lg", "luo"], ("Invalid non-en language in pair: %s", non_en)
