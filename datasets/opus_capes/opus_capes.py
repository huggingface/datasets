...
total number of tokens: 77.56M
total number of sentence fragments: 2.32M
"""
...
_VERSION = "1.0.0"
_BASE_NAME = "CAPES.{}.{}"
_BASE_URL = "https://object.pouta.csc.fi/OPUS-CAPES/v1/moses/{}-{}.txt.zip"
_LANGUAGE_PAIRS = [
    ("en", "pt"),
]


class CapesConfig(datasets.BuilderConfig):
...
class Capes(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIG_CLASS = CapesConfig
