...
class Openbookqa(nlp.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager):
    ...
    train_file = os.path.join(data_dir, 'train.jsonl') if self.config.name == 'main' else os.path.join(data_dir, 'train_complete.jsonl')
    test_file = os.path.join(data_dir, 'test.jsonl') if self.config.name == 'main' else os.path.join(data_dir, 'test_complete.jsonl')
    dev_file = os.path.join(data_dir, 'dev.jsonl') if self.config.name == 'main' else os.path.join(data_dir, 'dev_complete.jsonl')
    return [
          nlp.SplitGenerator(
