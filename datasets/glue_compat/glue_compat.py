...
Compatible with `run_glue.py` script in transformers<3.5.0.
"""
...
This version is compatible with the label assignments of MNLI and AX in legacy run_glue.py (transformers<3.5.0).
...
class GlueCompatConfig(datasets.BuilderConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super(GlueCompatConfig, self).__init__(version=datasets.Version("1.0.0", ""), **kwargs)
...
class GlueCompat(datasets.GeneratorBasedBuilder):
    """The General Language Understanding Evaluation (GLUE) benchmark."""
