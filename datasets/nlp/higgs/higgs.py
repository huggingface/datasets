...
class Higgs(nlp.GeneratorBasedBuilder):
  """HIGGS Data Set."""
  VERSION = nlp.Version(
  ...
  def _info(self):
    return nlp.DatasetInfo(
        ...
        features=nlp.features.FeaturesDict({
            'class_label': nlp.float32,  # 1 for signal, 0 for background
            # 21 low-level features
            'lepton_pT': nlp.float64,
            'lepton_eta': nlp.float64,
            'lepton_phi': nlp.float64,
            'missing_energy_magnitude': nlp.float64,
            'missing_energy_phi': nlp.float64,
            'jet_1_pt': nlp.float64,
            'jet_1_eta': nlp.float64,
            'jet_1_phi': nlp.float64,
            'jet_1_b-tag': nlp.float64,
            'jet_2_pt': nlp.float64,
            'jet_2_eta': nlp.float64,
            'jet_2_phi': nlp.float64,
            'jet_2_b-tag': nlp.float64,
            'jet_3_pt': nlp.float64,
            'jet_3_eta': nlp.float64,
            'jet_3_phi': nlp.float64,
            'jet_3_b-tag': nlp.float64,
            'jet_4_pt': nlp.float64,
            'jet_4_eta': nlp.float64,
            'jet_4_phi': nlp.float64,
            'jet_4_b-tag': nlp.float64,
