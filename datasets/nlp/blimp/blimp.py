  ...
  def _info(self):
    return nlp.DatasetInfo(
        ...
        features=nlp.features.FeaturesDict({
            'sentence_good': nlp.string,
            'sentence_bad': nlp.string,
            'field': nlp.string,
            'linguistics_term': nlp.string,
            'UID': nlp.string,
            'simple_LM_method': nlp.bool,
            'one_prefix_method': nlp.bool,
            'two_prefix_method': nlp.bool,
            'lexically_identical': nlp.bool,
            'pair_id': nlp.int32,
        }),
