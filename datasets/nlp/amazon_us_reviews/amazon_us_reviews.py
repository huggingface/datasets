        ...
        features=nlp.features.FeaturesDict({
            "data":
                collections.OrderedDict([
                    ("marketplace", nlp.string), ("customer_id", nlp.string),
                    ("review_id", nlp.string), ("product_id", nlp.string),
                    ("product_parent", nlp.string), ("product_title", nlp.string),
                    ("product_category", nlp.string), ("star_rating", nlp.int32),
                    ("helpful_votes", nlp.int32), ("total_votes", nlp.int32),
                    ("vine", nlp.features.ClassLabel(names=["Y", "N"])),
                    ("verified_purchase",
                     nlp.features.ClassLabel(names=["Y", "N"])),
                    ("review_headline", nlp.string), ("review_body", nlp.string),
                    ("review_date", nlp.string)
                ])
        }),
