...
This is not a single dataset, therefore each split has its own license (the collection itself did not have additional restrictions)
All of the datasets require complying with Tweeter [Terms Of Service](https://twitter.com/tos%29) and Twitter API [Terms Of Service](https://developer.twitter.com/en/developer-terms/agreement-and-policy)
