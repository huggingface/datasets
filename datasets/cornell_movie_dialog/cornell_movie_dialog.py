  ...
  def _split_generators(self, dl_manager):
    ...
    return [
        nlp.SplitGenerator(
            ...
            gen_kwargs={
              'filepaths': os.path.join(dl_dir, 'cornell movie-dialogs corpus')
                },
        ),
    ]
