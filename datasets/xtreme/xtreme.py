...
_TATOEBA_LANG = ['afr', 'ara', 'ben', 'bul', 'deu', 'cmn', 'ell', 'est', 'eus', 'fin', 'fra', 'heb', 'hin',
                 'hun', 'ind', 'ita', 'jav', 'jpn', 'kat', 'kaz', 'kor', 'mal', 'mar', 'nld', 'pes', 'por', 'rus',
                 'spa', 'swh', 'tam', 'tgl', 'tha', 'tur', 'urd', 'vie']

_UD_POS_LANG = [
    'Afrikaans', 'Arabic', 'Basque', 'Bulgarian', 'Dutch', 'English', 'Estonian', 'Finnish', 'French',
    'German', 'Greek', 'Hebrew', 'Hindi', 'Hungarian', 'Indonesian', 'Italian', 'Japanese', 'Kazakh', 'Korean', 'Chinese', 'Marathi',
    'Persian', 'Portuguese', 'Russian', 'Spanish', 'Tagalog', 'Tamil', 'Telugu', 'Thai', 'Turkish', 'Urdu', 'Vietnamese', 'Yoruba'
]
_PAN_X_LANG = ['af', 'ar', 'bg', 'bn', 'de', 'el', 'en', 'es', 'et', 'eu', 'fa', 'fi', 'fr', 'he', 'hi', 'hu', 'id', 'it',
              'ja', 'jv', 'ka', 'kk', 'ko', 'ml', 'mr', 'ms', 'my', 'nl', 'pt', 'ru', 'sw', 'ta', 'te', 'th', 'tl', 'tr',
              'ur', 'vi', 'yo', 'zh']
...
_DESCRIPTIONS = {
    'tydiqa': textwrap.dedent("""\Gold passage task (GoldP): Given a passage that is guaranteed to contain the 
    ...
    'tatoeba': textwrap.dedent("""\
          ...
          low-resource languages, e.g. "Tom needed water", "Tom needs water", "Tom is getting water", ...
                    """),
    'bucc18': textwrap.dedent("""\Building and Using Comparable Corpora
          """),
...
class Xtreme(nlp.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        features = {
            text_feature: nlp.Value('string') for text_feature in six.iterkeys(self.config.text_features)
        }
        ...
        if self.config.name.startswith('MLQA'):
            ...
            return [
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(os.path.join(mlqa_downloaded_files, 'MLQA_V1/test'),
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(os.path.join(mlqa_downloaded_files, 'MLQA_V1/dev'),
        ...
        if self.config.name.startswith('XQuAD'):
            ...
            return [
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': xquad_downloaded_file
        ...
        if self.config.name.startswith('PAWS-X'):
            ...
            return [
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(data_dir, 'dev_2k.tsv')
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(data_dir, 'test_2k.tsv')
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(data_dir, 'translated_train.tsv') if lang != 'en' else os.path.join(
                            data_dir, 'train.tsv')
        ...
        if self.config.name.startswith('bucc18'):
            ...
            return [
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(bucc18_dl_dev_dir, 'bucc2018', lang + '-en')
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(bucc18_dl_test_dir, 'bucc2018', lang + '-en')
            ...
            if lang == 'Kazakh':
                return [
                    nlp.SplitGenerator(
                        ...
                        # These kwargs will be passed to _generate_examples
                        gen_kwargs={
                            'filepath': [os.path.join(folder, file) for folder in folders for file in os.listdir(folder)
        ...
        if self.config.name.startswith('PAN-X'):
            ...
            return [
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(lang_folder, 'test')
                ...
                nlp.SplitGenerator(
                    ...
                    # These kwargs will be passed to _generate_examples
                    gen_kwargs={
                        'filepath': os.path.join(lang_folder, 'train')
