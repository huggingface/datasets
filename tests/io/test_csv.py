...
def test_csv_dataset_reader(path_type, split, features, csv_path, tmp_path):
    ...
    dataset = CsvDatasetReader(path, split=split, features=features, cache_dir=cache_dir).read()
...
def test_csv_datasetdict_reader(split, features, csv_path, tmp_path):
    if split:
        path = {split: csv_path}
    else:
        split = "train"
    ...
    dataset = CsvDatasetReader(path, features=features, cache_dir=cache_dir).read()
