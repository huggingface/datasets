...
class AutomaticSpeechRecognitionTest(TestCase):
    def test_column_mapping(self):
        task = AutomaticSpeechRecognition(
            audio_column="input_audio_file_path", transcription_column="input_transcription"
        )
        self.assertDictEqual(
            {"input_audio_file_path": "audio", "input_transcription": "transcription"}, task.column_mapping
        )
    ...
    def test_from_dict(self):
        ...
        template_dict = {
            "audio_column": "input_audio_file_path",
