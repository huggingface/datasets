...
MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES = os.environ.get(
    "MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES", DEFAULT_MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES
)
MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES = (
    int(MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES)
    if MAX_IN_MEMORY_DATASET_SIZE_IN_BYTES not in {"", "OFF", "NO", "FALSE"}
    else None
)
