...
DEFAULT_MAX_DATASET_CONFIG_ID_READABLE_LENGTH = 255
MAX_DATASET_CONFIG_ID_READABLE_LENGTH = int(os.environ.get("HF_DATASETS_MAX_DATASET_CONFIG_ID_READABLE_LENGTH", DEFAULT_MAX_DATASET_CONFIG_ID_READABLE_LENGTH))
