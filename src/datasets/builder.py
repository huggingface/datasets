...
class DatasetBuilder:
    ...
    **Configuration**: Some `DatasetBuilder`s expose multiple variants of the
        ...
        **config_kwargs,
        ...
        Args:
            ...
            features: `Features`, optional features that will be used to read/write the dataset
                It can be used to change the :obj:`datasets.Features` description of a dataset for example.
    ...
    def get_exported_dataset_info(self) -> DatasetInfo:
        """Empty DatasetInfo if it doesn't exist"""
    ...
    def _relative_data_dir(self, with_version=True, with_hash=True) -> str:
        ...
        If any of these elements are missing or if ``with_version=False``, the corresponding subfolders are dropped.
        """
        ...
        for split in self.info.splits:
            for resource_file_name in self._post_processing_resources(split).values():
                ...
                try:
                    ...
                    logger.info(f"Couldn't download resource file {resource_file_name} from Hf google storage.")
