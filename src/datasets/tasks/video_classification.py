...
from ..features import Video, ClassLabel, Features
from .base import TaskTemplate


@dataclass(frozen=True)
class VideoClassification(TaskTemplate):
    task: str = field(default="video-classification", metadata={"include_in_asdict_even_if_is_default": True})
    input_schema: ClassVar[Features] = Features({"video": Video()})
