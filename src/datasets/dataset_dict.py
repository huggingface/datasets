...
class IterableDatasetDict(dict):
    ...
    def map(
        ...
        Args:
            function (`Callable`, optional, default None): Function applied on-the-fly on the examples when you iterate on the dataset
    ...
    def shuffle(
        ...
        Args:
            seed (`int`, optional, default None): random seed that will be used to shuffle the dataset.
            ...
            generator (`numpy.random.Generator`, optional): Numpy random Generator to use to compute the permutation of the dataset rows.
                If ``generator=None`` (default), uses np.random.default_rng (the default BitGenerator (PCG64) of NumPy).
            buffer_size (`int`, default 1000): size of the buffer.
