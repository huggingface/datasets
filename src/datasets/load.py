...
def prepare_module(
    ...
    **download_kwargs,
    ...
    dataset_infos = url_or_path_join(base_path, config.DATASET_INFOS_DICT_FILE_NAME)
    ...
    dataset_infos_path = os.path.join(hash_folder_path, config.DATASET_INFOS_DICT_FILE_NAME)
