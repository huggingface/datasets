...
class DatasetBuilder:
    ...
    **Configuration**: Some `DatasetBuilder`s expose multiple variants of the
    ...
    ```python
    mnist_builder = nlp.get_dataset_builder("mnist")
    ...
    def __init__(
        ...
        Args:
            cache_dir: `str`, directory to read/write data. Defaults to
                "~/nlp".
    ...
    def download_and_prepare(
        ...
        **download_and_prepare_kwargs,
        ...
        Args:
            cache_dir: `str`, directory where downloaded files are stored.
            dl_manager: `nlp.DownloadConfig`, further configuration for
