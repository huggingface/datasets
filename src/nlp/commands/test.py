...
def test_command_factory(args):
    return TestCommand(args.datasets, args.cache_dir, args.force, args.register_checksums)
...
class TestCommand(BaseTransformersCLICommand):
    ...
    def __init__(self, datasets: str, cache: str, force: bool, register_checksums: bool):
