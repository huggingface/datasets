...
def test_command_factory(args):
    return TestCommand(args.datasets, args.name, args.cache_dir, args.force, args.register_checksums, args.ignore_checksums)
...
class TestCommand(BaseTransformersCLICommand):
    ...
    def __init__(self, datasets: str, name: str, cache: str, force: bool, register_checksums: bool, ignore_checksums: bool):
